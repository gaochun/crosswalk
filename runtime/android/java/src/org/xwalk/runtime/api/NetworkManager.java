...
public class NetworkManager extends XWalkExtension {
        ...
        if (this.receiver == null) {
            this.receiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if(NetworkManager.this.app != null)                        
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        if (action.equals("getConnectionInfo")) {
            ...
            ExtensionResult pluginResult = new ExtensionResult(ExtensionResult.Status.OK, this.getConnectionInfo(info));
            pluginResult.setKeepCallback(true);
            callbackContext.sendExtensionResult(pluginResult);
            return true;
        }
        return false;
    }
    ...
    private void sendUpdate(String type) {
        if (connectionCallbackContext != null) {
            ExtensionResult result = new ExtensionResult(ExtensionResult.Status.OK, type);
            result.setKeepCallback(true);
            connectionCallbackContext.sendExtensionResult(result);
        }
        app.postMessage("networkconnection", type);
    }
