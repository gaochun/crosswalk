...
public class ExposedJsApi {
    ...
    public ExposedJsApi(XWalkExtensionManager extensionManager, NativeToJsMessageQueue jsMessageQueue) {
    ...
    public String exec(String service, String action, String callbackId, String arguments) throws JSONException {
        ...
        try {
            boolean wasSync = extensionManager.exec(service, action, callbackId, arguments);
            String ret = "";
